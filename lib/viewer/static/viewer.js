...
var render = function( json ) {
  ...
  tags.forEach( function(tag) {
    var data    = json[tag];
    var $link   = $('<a href="https://twitter.com/#!/search/realtime/' + encodeURIComponent(tag) + '">')
    var $cell   = $('<div>').addClass('cell').addClass( data.mapping.selector );
    var $helper = $('<a href="https://twitter.com/#!/search/realtime/' + encodeURIComponent(tag) + '" title="' + tag + '">').addClass('helper').text( tag );
